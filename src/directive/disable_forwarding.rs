...
#[doc = "Disables all forwarding features, including X11, [ssh-agent(1)](https://man.openbsd.org/ssh-agent.1), TCP and StreamLocal. This option overrides all other forwarding-related options and may simplify restricted configurations."]
#[doc = "See also: [DisableForwarding](https://man.openbsd.org/sshd_config#DisableForwarding)"]
