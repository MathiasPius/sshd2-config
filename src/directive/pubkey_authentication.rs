...
#[doc = "Specifies whether public key authentication is allowed. The default is **yes**."]
#[doc = "See also: [PubkeyAuthentication](https://man.openbsd.org/sshd_config#PubkeyAuthentication)"]
