...
#[doc = "Specifies whether password authentication is allowed. The default is **yes**."]
#[doc = "See also: [PasswordAuthentication](https://man.openbsd.org/sshd_config#PasswordAuthentication)"]
